...
import { ShoppingCart, FileText, Download, Shield, ChevronLeft, Plus, Minus, AlertCircle } from 'lucide-react';
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 h-full flex flex-col justify-center">
                ...
                {isApproved ? (
                  ...
                  <div className="border-t pt-6 bg-blue-50 p-4 rounded-lg">
                      <p className="text-blue-800 mb-2 font-medium">Acceso Profesional</p>
                      <Button size="lg" className="w-full" asChild><Link to="/registro">Solicitar Acceso B2B</Link></Button>
                  </div>
                )}
              </div>
            </motion.div>
            ...
            <Tabs defaultValue="documentation" className="w-full">
              ...
              <TabsContent value="documentation" className="mt-6">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="border rounded-lg p-4 flex items-center justify-between hover:border-blue-300 transition-colors">
                    <p className="font-semibold flex items-center"><Shield className="mr-2 h-5 w-5 text-blue-600"/> Ficha de Seguridad</p>
                    <Button variant="ghost" onClick={handleUnavailableDoc}><AlertCircle className="h-4 w-4 text-slate-400" /></Button>
                  </div>
                </div>
              </TabsContent>
              ...
              <TabsContent value="technical" className="mt-6">
                  <div className="space-y-2">
                      <p><strong>Uso:</strong> {product.usage || 'General'}</p>
                      <p><strong>Sector:</strong> {product.sector || 'General'}</p>
                  </div>
              </TabsContent>
            </Tabs>
          </div>
